...
//             break;
//            }
//           int c1=countnumber(arr, n, arr[l]);
//          int c2=countnumber(arr,n, arr[h]);
//             count+=(c1*c2);
//        h=h-c2;
//        l=l+c1;
//         }
        
//         else if(arr[i]+arr[h]+arr[l]<num)
//         {l++;}
...
/* Time Complexity : O(n^2) Space Complexity : O(n) where n is size of Array/List 
